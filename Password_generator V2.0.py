...
def guardar_en_escritorio(contraseña):
    ...
    ruta_archivo = os.path.join(escritorio, "contraseña_segura.txt")
...
def interfaz_bienvenida():
    print("Bienvenidos al Generador de Contraseñas Seguras de Arturo Cochea, comenzaremos a realizarte preguntas simples y concretas!")
